...
func (l *UpdateAIUsageLogic) UpdateAIUsage(req *types.UpdateAIUsageReq) (resp *types.UpdateAIUsageResp, err error) {
	// 调用RPC服务更新AI使用量
	rpcResp, err := l.svcCtx.SuperRpcClient.UpdateAIUsage(l.ctx, &super.UpdateAIUsageReq{
		UserId:    req.UserId,
